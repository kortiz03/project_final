...
class Ui_ConfirmerDelWindow(object):
    def setupUi(self, ConfirmerDelWindow):
        ...
        self.confirmDecon = QAction(ConfirmerDelWindow)
        self.confirmDecon.setObjectName(u"confirmDecon")
        ...
        self.label_3.setGeometry(QRect(0, 100, 63, 20))
        self.confirmDelCourriel = QLabel(self.CreationClient)
        self.confirmDelCourriel.setObjectName(u"confirmDelCourriel")
        self.confirmDelCourriel.setGeometry(QRect(50, 100, 63, 20))
        self.label_7 = QLabel(self.CreationClient)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setGeometry(QRect(0, 70, 63, 20))
        self.confirmDelPrenom = QLabel(self.CreationClient)
        self.confirmDelPrenom.setObjectName(u"confirmDelPrenom")
        self.confirmDelPrenom.setGeometry(QRect(50, 70, 63, 20))
        self.label_9 = QLabel(self.CreationClient)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(0, 40, 63, 20))
        self.confirmDelNom = QLabel(self.CreationClient)
        self.confirmDelNom.setObjectName(u"confirmDelNom")
        self.confirmDelNom.setGeometry(QRect(50, 40, 63, 20))
        self.label_10 = QLabel(self.CreationClient)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(0, 10, 63, 20))
        self.confirmDelUsager = QLabel(self.CreationClient)
        self.confirmDelUsager.setObjectName(u"confirmDelUsager")
        self.confirmDelUsager.setGeometry(QRect(50, 10, 63, 20))
        ...
        self.menuMenu.addAction(self.confirmDecon)
    ...
    def retranslateUi(self, ConfirmerDelWindow):
        ...
        self.confirmDecon.setText(QCoreApplication.translate("ConfirmerDelWindow", u"Se deconecter", None))
        self.confirmDelOk.setText(QCoreApplication.translate("ConfirmerDelWindow", u"Ok", None))
        ...
        self.label_10.setText(QCoreApplication.translate("ConfirmerDelWindow", u"Usager", None))
        self.confirmDelUsager.setText(QCoreApplication.translate("ConfirmerDelWindow", u"TextLabel", None))
